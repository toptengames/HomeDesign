  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord3.xyz) + (-_ColorX.xyz)));
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * in_f.texcoord3.xyz));
          u_xlatb2.xyz = float3(lessThan(abs(u_xlat2.xyzx), float4(float4(_Tolerance, _Tolerance, _Tolerance, _Tolerance))).xyz);
          ...
          u_xlat16.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          ...
          u_xlat0_d.xyz = float3((u_xlatb2.x)?(u_xlat5.xyz):(u_xlat0_d.xyz));
          u_xlat0_d.xyz = float3((float3(u_xlat21, u_xlat21, u_xlat21) * u_xlat0_d.xyz));
          out_f.color.w = u_xlat21;
          u_xlat16_6.xyz = float3((u_xlat0_d.xyz * _LightColor0.xyz));
    ...
    Pass // ind: 2, name: FORWARD
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2_d.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord3.xyz) + (-_ColorX.xyz)));
          u_xlat0_d.xyz = float3((u_xlat10_0.xyz * in_f.texcoord3.xyz));
          u_xlatb2.xyz = float3(lessThan(abs(u_xlat2_d.xyzx), float4(float4(_Tolerance, _Tolerance, _Tolerance, _Tolerance))).xyz);
          u_xlatb2.x = (u_xlatb2.y || u_xlatb2.x);
          u_xlatb2.x = (u_xlatb2.z || u_xlatb2.x);
          u_xlat9 = (_HueShift * 0.0174532942);
          u_xlat3.x = sin(u_xlat9);
          ...
          u_xlat16_6.xyz = float3((float3(u_xlat21, u_xlat21, u_xlat21) * _LightColor0.xyz));
          u_xlat16_6.xyz = float3((u_xlat0_d.xyz * u_xlat16_6.xyz));
    ...
    Pass // ind: 4, name: PREPASS
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat2.xyz = float3(((u_xlat10_0.xyz * in_f.texcoord2.xyz) + (-_ColorX.xyz)));
          ...
          u_xlat16_6.xyz = float3(max(u_xlat10_2.xyz, float3(0.00100000005, 0.00100000005, 0.00100000005)));
          u_xlat16_6.xyz = float3(log2(u_xlat16_6.xyz));
          u_xlat2.xyz = float3(((-u_xlat16_6.xyz) + in_f.texcoord5.xyz));
    ...
    Pass // ind: 5, name: DEFERRED
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          u_xlat14.xy = float2(((float2(float2(_Val, _Val)) * float2(0.298999995, 0.587000012)) + (-u_xlat1_d.yz)));
          u_xlat4_d.xy = float2(((float2(float2(_Val, _Val)) * float2(0.587000012, 0.114)) + u_xlat1_d.xw));
